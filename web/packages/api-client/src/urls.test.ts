...
describe("imageProxyUrl", () => {
  it("requests proxied remote images as AVIF", async () => {
    ...
    expect(imageProxyUrl("https://cdn.example.com/cover.jpg", undefined, { format: "avif" })).toBe(
      "/v1/media/image?url=https%3A%2F%2Fcdn.example.com%2Fcover.jpg&format=avif",
    );
  });
  ...
  it("adds AVIF format to existing media proxy URLs", async () => {
    ...
    ).toBe("/v1/media/image?source=test&spec=abc&format=avif");
  });
  ...
  it("adds responsive widths to proxied image URLs", async () => {
    ...
    expect(
      ...
      "/v1/media/image?url=https%3A%2F%2Fcdn.example.com%2Fcover.jpg&format=avif&width=384",
    );
  });
  ...
  it("builds a width descriptor srcset for proxied images", async () => {
    ...
    expect(
      ...
      "/v1/media/image?url=https%3A%2F%2Fcdn.example.com%2Fcover.jpg&format=avif&width=192 192w, /v1/media/image?url=https%3A%2F%2Fcdn.example.com%2Fcover.jpg&format=avif&width=384 384w",
    );
  });
