<script lang="ts">
  ...
  let {
    ...
    reencodeActionDisabled: boolean;
    ...
    selectedReencodeLoading: boolean;
    ...
    onReencode: (event: MouseEvent) => void;
  }>();
  ...
  function getActions() {
    return [
      ...
      {
        ariaLabel: $t("app.libraryDetail.reencodeSelected"),
        className: disabledActionClass(reencodeActionDisabled),
        description: $t("app.libraryDetail.reencodeSelectedDescription"),
        disabled: reencodeActionDisabled,
        icon: FileCog,
        iconClass: selectedReencodeLoading ? "animate-pulse" : "",
        label: $t("app.libraryDetail.reencodeSelected"),
        onclick: onReencode,
        variant: "outline" as const,
      },
      {
