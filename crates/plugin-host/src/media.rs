...
pub fn runtime_media_ref_to_spec(
    media: &manga::source::types::MediaRef,
) -> anyhow::Result<MediaRefSpec> {
    let mut spec = MediaRefSpec {
        url: media.url.clone(),
        request: media.request.as_ref().map(runtime_request_to_spec),
        transform: None,
    };
...
pub fn runtime_request_to_spec(request: &manga::source::types::FetchRequest) -> FetchRequestSpec {
    FetchRequestSpec {
...
fn http_method_name(method: manga::source::types::HttpMethod) -> String {
    match method {
        manga::source::types::HttpMethod::Get => "GET",
        manga::source::types::HttpMethod::Post => "POST",
        manga::source::types::HttpMethod::Put => "PUT",
        manga::source::types::HttpMethod::Patch => "PATCH",
        manga::source::types::HttpMethod::Delete => "DELETE",
        manga::source::types::HttpMethod::Head => "HEAD",
        manga::source::types::HttpMethod::Options => "OPTIONS",
    }
    .to_string()
}

fn request_purpose_to_spec(purpose: manga::source::types::RequestPurpose) -> RequestPurposeSpec {
    match purpose {
        manga::source::types::RequestPurpose::Api => RequestPurposeSpec::Api,
        manga::source::types::RequestPurpose::Document => RequestPurposeSpec::Document,
        manga::source::types::RequestPurpose::Image => RequestPurposeSpec::Image,
        manga::source::types::RequestPurpose::Asset => RequestPurposeSpec::Asset,
        manga::source::types::RequestPurpose::Custom => RequestPurposeSpec::Custom,
    }
}
